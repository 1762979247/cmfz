    ...
    <div style="height: 580px;padding:10px;background-image: linear-gradient(to top, #6fb0ff, #fffc9c)">
        <div>
            <form id="atl_fom" method="post">
                ...
                <p>文章作者：<select id="sel"  class="easyui-combobox" name="master.masterId"><option>--请选择--</option></select></p>
        ...
        <script type="text/javascript">
            ...
            $(function () {
                ...
                $('#btn1').linkbutton({
                    ...
                    onClick:function () {
                        $('#atl_fom').form('submit',{
                            ...
                            queryParams:{"articleContent":textContent},
                            onSubmit:function(){
                ...
                $('#sel').combobox({
                    editable:false,
                    width:100,
                    url:"${pageContext.request.contextPath}/master/searchAll",
                    valueField:'masterId',
