...
<script type="text/javascript">
    // 基于准备好的dom，初始化echarts实例,,"vintage"
        ...
        series: [
            {
                ...
                data: [
                    ...
                    {name: '上海',value: randomData() },{namroame: '重庆',value: randomData() },
    ...
    //        }, "json");
    //
            $.post("${pageContext.request.contextPath}/analyze/getFemale", function (data) {
                console.log(data);
                myChart.setOption({
                    series: [{
                        // 根据名字对应到相应的系列
